...
$new_book = [
    ...
    'num_pages' => filter_input(INPUT_POST, 'num_pages', FILTER_SANITIZE_INT),
    'author_name' => filter_input(INPUT_POST, 'author_name', FILTER_SANITIZE_STRING),
    'isbn' => filter_input(INPUT_POST, 'isbn', FILTER_SANITIZE_INT),
    'average_rating' => filter_input(INPUT_POST, 'average_rating', FILTER_SANITIZE_NUMBER_FLOAT),
    'book_published' => filter_input(INPUT_POST, 'book_published', FILTER_SANITIZE_INT)
];
